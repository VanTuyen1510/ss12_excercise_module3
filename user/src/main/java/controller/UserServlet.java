...
public class UserServlet extends HttpServlet {
    private static final long serialVersionUID = 1L; // serialVersionUID là gì ???
//    private String encoding = "utf-8";
    ...
    private void showSort(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<User> nameUser = userDAO.sortByName();
    ...
    private void searchByCountry(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<User> countryUser = userDAO.searchByCountry(country);
        request.setAttribute("countryUser",countryUser);
